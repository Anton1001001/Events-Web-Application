...
public class GetEventByNameHandlerTests
{
    ...
    public GetEventByNameHandlerTests()
    {
    ...
    {
        var request = TestDataFactory.CreateGetEventByNameQuery();
        ...
        var handler = new GetEventByNameHandler(_unitOfWorkMock.Object, _mapperMock.Object, 
        ...
        _unitOfWorkMock.Verify(u => u.EventRepository
            .GetByNameAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
